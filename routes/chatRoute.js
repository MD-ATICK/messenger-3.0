...
const { open_friend_chatbox, open_group_chatbox, nijer_chats, chat_click_unseeen_status, send_message_unseeen_status, chatBlocked } = require('../controllers/chatControllers')
...
router.put('/chat/blockOrUnblock', userAuth, chatBlocked)
